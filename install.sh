...
PIXMAN="http://www.cairographics.org/releases/pixman-0.32.6.tar.gz"
...
LIBPNG="http://downloads.sourceforge.net/project/libpng/libpng16/1.6.17/libpng-1.6.17.tar.gz"
GIF_LIB="http://downloads.sourceforge.net/project/giflib/giflib-5.1.1.tar.gz"
PREFIX=${1-/usr/local}
